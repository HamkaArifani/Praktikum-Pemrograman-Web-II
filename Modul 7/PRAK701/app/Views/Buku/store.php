    ...
    <div class="bg-white px-10 py-[45px] rounded-xl shadow-[0_4px_30px_rgba(0,0,0,0.03)] w-full max-w-[500px]">
        ...
        <form action="<?= base_url('buku/store') ?>" method="post" novalidate>
            ...
            <div class="mb-[35px]">
                ...
                <input type="text" id="judul" name="judul" value="<?= old('judul') ?>" placeholder="Masukkan judul buku"
            ...
            <div class="mb-[35px]">
                ...
                <input type="text" id="penulis" name="penulis" value="<?= old('penulis') ?>" placeholder="Masukkan nama penulis"
            ...
            <div class="mb-[35px]">
                ...
                <input type="number" id="tahun_terbit" name="tahun_terbit" value="<?= old('tahun_terbit') ?>" placeholder="Contoh: 2024"
                ...
                <?php else: ?>
                    <p class="mt-1 text-[11px] text-slate-400 italic">Format 4 digit angka</p>
                <?php endif; ?>
            </div>
